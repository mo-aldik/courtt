...
const endpoint = isProd ? 'dashboard2/api/v1/cs-decisions' : 'dashboard2/api/v1/cs-decisions-static';

export const getCsDecisionsApiEndpointIdentifier = endpoint;
...
export function useGetCsDecisionsApi(options?: Options): ReturnType {
  const now = new Date();
