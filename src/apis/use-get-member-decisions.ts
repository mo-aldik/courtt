...
const endpoint = isProd
  ? 'dashboard2/api/v1/member-decisions-statistics'
  : 'dashboard2/api/v1/member-decisions-statistics-static';

export const getMemberDecisionsApiEndpointIdentifier = endpoint;
...
export function useGetMemberDecisionsApi(options?: Options): ReturnType {
  const now = new Date();
