...
const endpoint = isProd ? 'dashboard2/api/v1/voucher-statistics' : 'dashboard2/api/v1/voucher-statistics-static';

export const getVoucherApiEndpointIdentifier = endpoint;
...
export function useGetVoucherApi(options?: Options): ReturnType {
  const now = new Date();
