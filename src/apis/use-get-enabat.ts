...
const endpoint = isProd ? 'dashboard2/api/v1/enabat-statistics' : 'dashboard2/api/v1/enabat-statistics-static';

export const getEnabatApiEndpointIdentifier = endpoint;
...
export function useGetEnabatApi(options?: Options): ReturnType {
  const now = new Date();
