...
const endpoint = isProd ? 'dashboard2/api/v1/settlement-statistics' : 'dashboard2/api/v1/settlement-statistics-static';

export const getSettlementApiEndpointIdentifier = endpoint;
...
export function useGetSettlementApi(options?: Options): ReturnType {
  const now = new Date();
