...
const endpoint = isProd
  ? 'dashboard2/api/v1/judge-decisions-breakdown'
  : 'dashboard2/api/v1/judge-decisions-breakdown-static';

export const getJudgeDecisionsBreakdownApiEndpointIdentifier = endpoint;
...
export function useGetJudgeDecisionsBreakdownApi(options?: Options): ReturnType {
  const now = new Date();
