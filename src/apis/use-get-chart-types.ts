...
const endpoint = isProd ? 'dashboard2/api/v1/chart-types' : 'dashboard2/api/v1/chart-types';

export const getChartTypesApiEndpointIdentifier = endpoint;
...
export function useGetChartTypesApi(options?: Options): ReturnType {
  const queryFn = async () => {
    try {
