...
const endpoint = isProd
  ? 'dashboard2/api/v1/comprehensive-petitions'
  : 'dashboard2/api/v1/comprehensive-petitions-static';

export const getComprehensivePetitionsApiEndpointIdentifier = endpoint;
...
export function useGetComprehensivePetitionsApi(options?: Options): ReturnType {
  const now = new Date();
