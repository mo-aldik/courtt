...
const endpoint = isProd ? 'dashboard2/api/v1/cs-cases' : 'dashboard2/api/v1/cs-cases-static';

export const getCsCasesApiEndpointIdentifier = endpoint;
...
export function useGetCsCasesApi(options?: Options): ReturnType {
  const now = new Date();
