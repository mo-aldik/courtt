...
const endpoint = isProd ? 'dashboard2/api/v1/haste-cases' : 'dashboard2/api/v1/haste-cases-static';

export const getHasteCasesApiEndpointIdentifier = endpoint;
...
export function useGetHasteCasesApi(options?: Options): ReturnType {
  const now = new Date();
