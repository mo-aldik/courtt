...
const endpoint = isProd
  ? 'dashboard2/api/v1/smart-petitions-statistics'
  : 'dashboard2/api/v1/smart-petitions-statistics-static';

export const getSmartPetitionsApiEndpointIdentifier = endpoint;
...
export function useGetSmartPetitionsApi(options?: Options): ReturnType {
  const now = new Date();
