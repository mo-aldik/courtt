...
const endpoint = isProd
  ? 'dashboard2/api/v1/disbursement-statistics'
  : 'dashboard2/api/v1/disbursement-statistics-static';

export const getDisbursementStatisticsApiEndpointIdentifier = endpoint;
...
export function useGetDisbursementStatisticsApi(options?: Options): ReturnType {
  const now = new Date();
