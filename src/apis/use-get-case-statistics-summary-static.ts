...
const endpoint = isProd
  ? 'dashboard2/api/v1/case-statistics-summary'
  : 'dashboard2/api/v1/case-statistics-summary-static';

export const getCaseStatisticsSummaryStaticApiEndpointIdentifier = endpoint;
...
export function useGetCaseStatisticsSummaryStaticApi(options?: Options): ReturnType {
  const now = new Date();
