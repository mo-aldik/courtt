...
const endpoint = isProd ? 'dashboard2/api/v1/fees-fines-cases' : 'dashboard2/api/v1/fees-fines-cases-static';

export const getFeesApiEndpointIdentifier = endpoint;
...
export function useGetFeesApi(options?: Options): ReturnType {
  const now = new Date();
