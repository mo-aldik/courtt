...
const endpoint = isProd ? 'dashboard2/api/v1/auctions' : 'dashboard2/api/v1/auctions-static';

export const getAuctionsApiEndpointIdentifier = endpoint;
...
export function useGetAuctionsApi(options?: Options): ReturnType {
  const now = new Date();
